...
export declare function outboxHandler(req: IncomingMessage, res: ServerResponse, serviceAccount: ServiceAccount, databaseService: Database, deliveryService: DeliveryService): Promise<{
    props?: {
