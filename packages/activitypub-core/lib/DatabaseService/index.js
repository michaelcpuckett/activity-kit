...
class DatabaseService {
    ...
    static async connect() {
        const client = new mongodb_1.MongoClient(globals_1.MONGO_CLIENT_URL, {
            minPoolSize: 10,
        });
        await client.connect();
        const db = client.db(globals_1.DB_NAME);
        return new DatabaseService(db, isomorphic_fetch_1.default);
    }
