...
async function getCollectionItems(entity) {
    ...
    if (collection.type !== types_1.AP.CollectionTypes.COLLECTION &&
        collection.type !== types_1.AP.CollectionTypes.ORDERED_COLLECTION) {
        return [];
    }
    ...
    const collectionItems = collection.type === types_1.AP.CollectionTypes.ORDERED_COLLECTION
