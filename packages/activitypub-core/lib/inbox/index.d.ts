...
export declare function inboxHandler(req: IncomingMessage, res: ServerResponse, serviceAccount: ServiceAccount, databaseService: Database, deliveryService: DeliveryService): Promise<{
    props?: {
