...
const getTypedEntity = (entity) => {
    for (const linkType of Object.values(src_1.AP.LinkTypes)) {
        if (entity.type === linkType) {
            return entity;
        }
    }
    for (const activityType of Object.values(src_1.AP.ActivityTypes)) {
        if (entity.type === activityType) {
            return entity;
        }
    }
    for (const actorType of Object.values(src_1.AP.ActorTypes)) {
    ...
    for (const objectType of Object.values(src_1.AP.ExtendedObjectTypes)) {
