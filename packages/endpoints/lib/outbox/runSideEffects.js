...
async function runSideEffects() {
    try {
        ...
        if ((0, types_1.isType)(this.activity, types_1.AP.ActivityTypes.DELETE)) {
        ...
        if ((0, types_1.isType)(this.activity, types_1.AP.ActivityTypes.BLOCK)) {
            await this.handleBlock(this.activity);
        }
        if ((0, types_1.isType)(this.activity, types_1.AP.ActivityTypes.UPDATE)) {
        ...
        if ((0, types_1.isType)(this.activity, types_1.AP.ActivityTypes.ADD)) {
            await this.handleAdd(this.activity);
        }
        if ((0, types_1.isType)(this.activity, types_1.AP.ActivityTypes.REMOVE)) {
            await this.handleRemove(this.activity);
        }
        if ((0, types_1.isType)(this.activity, types_1.AP.ActivityTypes.UNDO)) {
