...
async function respond() {
    ...
    if (version === 2) {
        this.res.setHeader(utilities_1.CONTENT_TYPE_HEADER, utilities_1.JSON_CONTENT_TYPE);
        ...
        this.res.write(JSON.stringify({
            links: [
                {
                    href: `${utilities_1.LOCAL_DOMAIN}/nodeinfo/2.0`,
                    rel: `http://nodeinfo.diaspora.software/ns/schema/2.0`,
                },
                {
                    href: `${utilities_1.LOCAL_DOMAIN}/nodeinfo/2.1`,
