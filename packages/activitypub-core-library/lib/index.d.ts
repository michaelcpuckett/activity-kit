import { AP, AuthAdapter, CryptoAdapter, DbAdapter, FetchPolyfill, StorageAdapter, Library } from 'activitypub-core-types';
...
export declare class CoreLibrary implements Library {
    ...
    getStreamByName: (this: CoreLibrary, actor: AP.Actor, name: string) => Promise<AP.EitherCollection>;
