...
export declare type DeliveryAdapter = {
    ...
    getRecipientInboxUrls: (this: DeliveryAdapter, activity: AP.Activity, actor: AP.Actor, inboxesOnly?: boolean) => Promise<URL[]>;
    getRecipientUrls: (this: DeliveryAdapter, activity: AP.Activity) => Promise<URL[]>;
};
